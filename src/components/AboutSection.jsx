...
const AboutSection = () => {
  return (
    <section className="py-24 bg-gradient-yellow relative overflow-hidden">
      {/* Pattern Background */}
      ...
      <div className="container-large relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <h2 className="text-4xl lg:text-5xl font-bold text-text mb-8 leading-tight">
              A Legacy of
              <span className="block text-secondary mt-2">Punjabi Flavors</span>
            </h2>
          ...
          >
            <div className="relative aspect-square overflow-hidden rounded-2xl">
              ...
              />
              <div className="absolute inset-0 border-2 border-secondary/20 
            ...
            <div className="absolute -top-6 -right-6 w-24 h-24 
                          bg-gradient-orange rounded-full opacity-30 
                          blur-2xl"></div>
            <div className="absolute -bottom-6 -left-6 w-24 h-24 
                          bg-gradient-purple rounded-full opacity-30 
                          blur-2xl"></div>
          </motion.div>
        </div>
      </div>
